...
function AirConditionerApi(ipAddress, duid, token, log, logSocketActivity) {
...
AirConditionerApi.prototype = {
    connect: function () {
        ...
        this.socket = tls.connect(options, function () {
            ...
            keepAlive.setKeepAliveInterval(this.socket, 2000);
            keepAlive.setKeepAliveProbes(this.socket, 5);
